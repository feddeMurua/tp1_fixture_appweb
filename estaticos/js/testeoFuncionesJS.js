...
function armar_llaves(json, ganador_grupo_1, ganador_grupo_2, llave, fase) {
  ...
  $.each(json["partidos"][llave], function(i, f) {
    ...
    var equipo_1 = "<label id='"+f.equipo_1+"'>" + nombre_equipo1 + "</label>" ;
    var input_equipo_1 = "<input id='"+f.equipo_1+"_"+f.fecha+"' type='number' min='0' style='width:30%; text-align:center; size='35''/>  ";
    var input_equipo_2 = "<input id='"+f.equipo_2+"_"+f.fecha+"' type='number' min='0' style='width:30%; text-align:center; size='35''/>";
    ...
    $(tbody).appendTo(llave);
    $(tr).appendTo(llave);
    $(td).appendTo(llave);
    $(imgEquipo1).appendTo(llave);
    $(fintd).appendTo(llave);
    //$(llave).append(" ");
    $(td).appendTo(llave);
